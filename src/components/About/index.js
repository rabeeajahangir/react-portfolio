...
const About = () => {
    return(
        <section className="my-5" >
            ...
            <br/><br/>
            When I am not working or coding, I love to spend time with my family (I have 2 young kids), exploring new places and netflix. I also love reading, music, and travelling. I would describe myself as an Extroverted Introvert. I love talking to people and socializing but also need my precious 'me' time :) and like to keep my circle small.
            </p>
            </div>
            <div><Footer/></div>
